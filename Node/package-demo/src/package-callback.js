 ...
 */
function createHTMLFile(folderPath, callback) {
 ...
 */
function createCSSFile(folderPath, callback) {
 ...
 * 开启本地服务，打开静态文件
 */
function openIndexPage(folderPath, callback) {
...
createPublicFolder(function (path) {
    createHTMLFile(path, function () {
        createCSSFile(path, function () {
            openIndexPage(path)
        })
    })
})
